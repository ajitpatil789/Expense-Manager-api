...
public class ExpenseController {
	...
	@Autowired
	private ExpenseService expenseService; // ExpenseService method is injected.

	@GetMapping("/expenses")
	public List<Expense> getAllExpenses(Pageable page) {

//		int number=1;                        // example of general exception
//		calculateFactorial(number);
	...
	public void deleteExpenseID(@PathVariable("id") long id) {
